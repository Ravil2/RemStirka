...
export default function Reviews() {
  ...
  return (
    <>
      <Head>
        <title>
          Отзывы клиентов о RemStirka.kz | Ремонт стиральных машин в Алматы
        </title>
        <meta
          name="description"
          content="Читайте реальные отзывы наших клиентов о сервисе ремонта стиральных машин RemStirka.kz в Алматы. Узнайте, почему нас рекомендуют."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://remstirka.kz/#reviews" />
      </Head>
